...
public class PlayerSprintAndCrouch : MonoBehaviour {
    ...
    private float prone_height = 0.5f;

    public bool is_Crouching;
    public bool is_proning;

    private PlayerFootsteps player_Footsteps;

    private float sprint_Volume = 1f;
    private float crouch_Volume = 0.3f;
    private float prone_volume = 0.1f;
    private float walk_Volume_Min = 0.4f, walk_Volume_Max = 0.6f;

    private float walk_Step_Distance = 0.4f;
    private float sprint_Step_Distance = 0.25f;
    private float crouch_Step_Distance = 0.5f;
    private float prone_step_dist = 0.8f;
    ...
    void Prone()
    {
        if (Input.GetKeyDown(KeyCode.Z))
        {
            ...
            else
            {
                ...
                player_Footsteps.step_Distance = prone_step_dist;
